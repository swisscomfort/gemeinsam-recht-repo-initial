...
2. `DER_PLAN_v1.1_FROZEN.md` — der komplette, eingefrorene Plan (allein massgeblich)
...
**Neuer KI-Chat:** Inhalt von `SESSION_KOPF.txt` einfügen, `DER_PLAN_v1.1_FROZEN.md`
